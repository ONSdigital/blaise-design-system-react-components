  ...
  return (
    <header className="ons-header ons-header--internal">
      <div className="ons-browser-banner">
        <div className="ons-container">
          <p className="ons-browser-banner__content">
            <span className="ons-browser-banner__lead">
              This website no longer supports your browser.
            </span>
            <span className="ons-browser-banner__cta">
              {" "}
              You can{" "}
              <a
      ...
      <div className="ons-header__top">
        <div className="ons-container">
          <div className="ons-header__grid-top ons-grid ons-grid-flex ons-grid-flex--between ons-grid-flex--vertical-center ons-grid-flex--no-wrap ons-grid--gutterless">
            <div className="ons-grid__col ons-col-auto">
              <a
                className="ons-header__org-logo-link"
                href="/"
              >
                <div className="ons-header__org-logo ons-header__org-logo--large">
                  <svg
                ...
                <div className="ons-header__org-logo ons-header__org-logo--small">
                  <svg
                    className="ons-icon--logo"
                    xmlns="http://www.w3.org/2000/svg"
                    width="120"
      ...
      <div className="ons-header__main">
        <div className="ons-container">
          <div className="ons-grid ons-grid-flex ons-grid-flex--between ons-grid-flex--vertical-center ons-grid-flex--no-wrap">
