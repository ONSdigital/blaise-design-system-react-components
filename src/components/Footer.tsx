    ...
    <footer className="ons-footer">
      ...
      >
        <div className="ons-container">
          <div className="ons-grid"></div>
          <div className="ons-grid ons-grid-flex--vertical-top ons-grid-flex--between">
            <div className="ons-grid__col">
              <div className="ons-footer__logo-container ons-u-mb-l ons-grid-flex ons-grid-flex--vertical-top">
                <a
                  className="ons-footer__logo-link"
                  href="https://www.ons.gov.uk/"
                >
                  <div className="ons-footer__logo-large">
                    <svg
                  ...
                  <div className="ons-footer__logo-small">
                    <svg
                      className="ons-icon--logo"
                      xmlns="http://www.w3.org/2000/svg"
                      width="120"
