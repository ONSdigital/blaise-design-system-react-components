...
import t, { Component, useRef, useEffect, Fragment as Fragment$1, createElement, useState } from 'react';
...
function Header(_ref) {
  ...
  return jsxs("header", {
    ...
    }), navigationLinks && navigationLinks.length !== 0 && jsx("div", {
      ...
      children: jsxs("div", {
        ...
        children: [jsx("div", {
          ...
          children: jsxs("p", {
            ...
            children: ["This is a new service \u2013 your\xA0", jsx("a", {
...
var ONSButton = function ONSButton(props) {
  ...
  return jsx("button", {
    ...
    children: jsxs("span", {
      className: "ons-btn__inner",
      children: [props.label, props.loading && jsxs("svg", {
...
var ONSPanel = function ONSPanel(props) {
  ...
  return jsxs("div", {
    ...
    className: className,
    hidden: props.hidden,
    children: [props.status === "success" && jsx("span", {
      className: "ons-panel__icon",
      children: jsx("svg", {
    ...
    }), props.status === "warn" && jsxs(Fragment, {
      children: [jsx("span", {
        className: "ons-panel__icon",
        "aria-hidden": "true",
        children: "!"
...
var ONSSelect = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(ONSSelect, [{
    ...
    value: function render() {
      var _this2 = this;
      return jsxs("div", {
        children: [this.props.label !== undefined && jsxs("label", {
          className: "ons-label",
...
var ONSTextInput = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(ONSTextInput, [{
    ...
    value: function render() {
      ...
      return jsxs("p", {
        className: "ons-field",
        children: [this.props.label !== undefined && jsx("label", {
          className: "ons-label",
          htmlFor: this.props.id,
          children: this.props.label
        }), jsx("input", {
      ...
      return jsx("div", {
        ...
        children: jsxs("p", {
          ...
          children: [jsxs("label", {
            ...
            children: [this.props.label, jsx("br", {}), jsx("span", {
      ...
      children: radioOptions && radioOptions.length > 0 && radioOptions.map(function (radioOption, radioOptionIndex) {
        return jsxs(Fragment$1, {
          children: [jsx("p", {
            ...
            children: jsxs("span", {
              className: "ons-radio",
              children: [jsx(Field, _objectSpread2(_objectSpread2({
                type: "radio",
                id: radioOption.id,
                name: name,
                ...
                children: [radioOption.label, radioOption.description !== undefined && jsx("span", {
              ...
              }), radioOption.specifyOption && jsxs("span", {
          ...
          children: [jsx("p", {
            ...
            children: jsxs("span", {
              ...
              children: [jsx(Field, _objectSpread2(_objectSpread2({
                ...
                children: [checkboxOption.label, checkboxOption.description !== undefined && jsx("span", {
                  id: "white-label-description-hint",
...
function ONSInputField(_ref3) {
  ...
  return jsxs("div", {
    ...
    children: [jsx("label", {
      ...
      children: description
    }), jsx("input", _objectSpread2(_objectSpread2({
      id: id,
      className: "ons-input ons-input--text ons-input-type__input"
    }, field), {}, {
...
var StyledFormField = function StyledFormField(_ref) {
  ...
  var newField;
  if (props.type === "radio") {
    newField = jsx(RadioFieldset, _objectSpread2({
    ...
    newField = jsx(CheckboxesFieldset, _objectSpread2({
      description: description,
      name: name,
    ...
    newField = jsx(Field, _objectSpread2(_objectSpread2({
      name: name,
      description: description,
      autoFocus: autoFocus
    }, props), {}, {
...
function StyledForm(_ref) {
  ...
  return jsx(Formik, {
    ...
    children: function children(_ref3) {
      ...
      return jsxs(Form, {
        children: [jsx(StyledFormErrorSummary, {}), fields.map(function (field, index) {
          var isAutoFocus = isValid && index === 0;
          return jsx(Fragment$1, {
            children: jsx(StyledFormField, _objectSpread2(_objectSpread2({}, field), {}, {
              autoFocus: isAutoFocus
            }))
          }, field.name);
        }), jsx("br", {}), jsx(ONSButton, {
          submit: true,
...
function ONSTable(_ref) {
  ...
  return jsxs("table", {
    ...
    "data-testid": tableID,
    id: tableID,
    children: [tableCaption && jsx("caption", {
...
function Accordion(_ref3) {
  ...
  var _useState = useState(expandableStates),
    _useState2 = _slicedToArray(_useState, 2),
