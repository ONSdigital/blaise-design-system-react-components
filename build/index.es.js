import React, { Component, useEffect, Fragment, useRef, useDebugValue, useContext, createElement, useState } from 'react';
...
function RadioFieldset(_a) {
    ...
    return (React.createElement("fieldset", { className: "ons-fieldset" },
        ...
        React.createElement("div", { className: "ons-radios__items", id: name }, (radioOptions && radioOptions.length > 0
            && radioOptions.map(function (radioOption, radioOptionIndex) { return (React.createElement(Fragment, { key: radioOption.id },
                React.createElement("p", { className: "ons-radios__item" },
                    React.createElement("span", { className: "ons-radio" },
                        React.createElement(Field, __assign$w({ type: "radio", id: radioOption.id, name: name, value: radioOption.value, className: "ons-radio__input js-radio" }, props, { autoFocus: props.autoFocus && radioOptionIndex === 0 })),
...
function CheckboxesFieldset(_a) {
    ...
    return (React.createElement("fieldset", { className: "ons-fieldset" },
        ...
        React.createElement("div", { className: "checkboxes__items", id: name }, (checkboxOptions && checkboxOptions.length > 0
            && checkboxOptions.map(function (checkboxOption, checkboxIndex) { return (React.createElement(Fragment, { key: checkboxOption.id },
                React.createElement("p", { className: "ons-checkboxes__item" },
                    React.createElement("span", { className: "ons-checkbox" },
                        React.createElement(Field, __assign$w({ type: "checkbox", id: checkboxOption.id, name: name, value: checkboxOption.value, className: "ons-checkbox__input js-checkbox" }, props, { autoFocus: props.autoFocus && checkboxIndex === 0 })),
...
var ONSInputField = function (_a) {
    ...
    return (React.createElement("div", { className: "ons-field" },
        ...
        React.createElement("input", __assign$w({ id: id, className: "ons-input ons-input--text ons-input-type__input " }, field, props))));
};
...
var StyledFormField = function (_a) {
    ...
    var newField;
    if (props.type === "radio") {
        newField = (React.createElement(RadioFieldset, __assign$w({ description: description, name: name, radioOptions: radioOptions }, props)));
    }
    else if (props.type === "checkbox") {
        newField = (React.createElement(CheckboxesFieldset, __assign$w({ description: description, name: name, checkboxOptions: checkboxOptions }, props)));
    }
    else {
        newField = React.createElement(Field, __assign$w({ name: name, description: description }, props, { component: ONSInputField }));
    }
    return (React.createElement(Fragment, { key: name }, errors[name]
    ...
    return (React.createElement(Formik, { validateOnBlur: false, validateOnChange: false, initialValues: initialFieldValues, onSubmit: function (values, _a) {
        ...
        return (React.createElement(Form, null,
            ...
            fields.map(function (field, index) {
                ...
                return (React.createElement(Fragment, { key: field.name }, // @ts-ignore
                React.createElement(StyledFormField, __assign$w({}, field))));
            }),
            React.createElement("br", null),
...
var TailSpin = function (_a) {
    ...
    return (React.createElement("div", __assign$g({ style: __assign$g(__assign$g({}, getDefaultStyle(visible)), wrapperStyle), className: wrapperClass, "data-testid": "tail-spin-loading", "aria-label": ariaLabel }, DEFAULT_WAI_ARIA_ATTRIBUTE),
...
var ONSLoadingPanel = function (_a) {
    ...
    return (React.createElement(ONSPanel, { hidden: hidden },
        React.createElement("div", { style: { textAlign: "center" } },
            React.createElement(TailSpin, { color: "#064868", height: 30, width: 30, ariaLabel: "tail-spin-loading", radius: "1", wrapperStyle: { display: "inline-block", width: "100%", textAlign: "center" }, visible: true }),
            message || "Loading")));
};
