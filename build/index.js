...
function StyledForm(_a) {
    ...
    return (React__default['default'].createElement(Formik, { validateOnBlur: false, validateOnChange: false, initialValues: initialFieldValues, onSubmit: function (values, _a) {
            var setSubmitting = _a.setSubmitting;
            onSubmitFunction(values, setSubmitting);
        } }, function (_a) {
        var errors = _a.errors, isSubmitting = _a.isSubmitting, isValid = _a.isValid;
        return (React__default['default'].createElement(Form, null,
            ErrorSummary(isValid, errors),
            fields.map(function (field, index) {
                field.autoFocus = (index === 0);
                return (React__default['default'].createElement(React.Fragment, { key: field.name }, 
                // @ts-ignore
                errors[field.name] ?
                    // @ts-ignore
                    InputErrorPanel(
                    // @ts-ignore
                    errors[field.name], "name", React__default['default'].createElement(Field, __assign({}, field, { component: ONSInputField })))
                    :
                        React__default['default'].createElement(Field, __assign({}, field, { component: ONSInputField }))));
            }),
            React__default['default'].createElement("br", null),
            React__default['default'].createElement("button", { type: "submit", className: "btn", disabled: isSubmitting, "data-testid": "submit-btn" },
                React__default['default'].createElement("span", { className: "btn__inner" }, "Save and continue"))));
    }));
}
